...
export type PlotOptionsProps = {
  series?: {
    ...
    dataLabels?: {
      ...
      textPath?: { attributes?: Highcharts.SVGAttributes; enabled?: boolean };
      useHTML?: boolean;
    ...
    onPoint?: {
      ...
      id?: string;
      position?: { offsetX?: number; offsetY?: number; x?: number; y?: number };
    };
    opacity?: number;
    point?: {
      events?: {
...
export function PlotOptions(props: PlotOptionsProps) {
  return null;
}
