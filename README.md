...
**Note: a preview of the upcoming v4 of the Highcharts React integration is 
now available as [`@highcharts/react@next`](https://www.npmjs.com/package/@highcharts/react/v/4.0.1)**
